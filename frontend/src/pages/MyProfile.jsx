...
import { assets } from '../assets/assets.js' // Update path based on your project structure
...
const MyProfile = () => {
  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
     ...
     src={image ? URL.createObjectURL(image) : (userData.image || 'default-image-url.jpg')} 
     alt=''/>
...
<img className='w-10 absolute bottom-12 right-12' src={image ? '' : ''} alt='' />
      ...
      <div>
        <p className='text-neutral-500 mt-4 font-medium'>CONTACT INFORMATION</p>
      ...
      <div>
        <p className='text-neutral-500 mt-4 font-medium'>GENERAL INFORMATION</p>
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
      ...
      <div className='mt-10'>
        {
          isEdit
            ? <button className='border border-primary px-8 py-2 rounded-full cursor-pointer hover:bg-primary hover:text-white transition-all' onClick={updateUserProfiledata}>Save</button>
